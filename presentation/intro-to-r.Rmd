...
data <- carbon_long %>%
  ...
  filter(!is.na(emissions) & !is.na(region)) %>%
...
In Wickham's tutorial, he indicated that there are 3 main components for every ggplot2 plot.
  ...
  3. At least one layer which describes how to render each observations. Layers are usually created with a *geom* function

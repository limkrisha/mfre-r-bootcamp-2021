...
Sometimes, you will find it useful to write your own functions to automate certain tasks and to reuse them later on.  If you find yourself repeating the same steps (in your current or across multiple scripts), writing a function may help you save time and also avoid mistakes. It is [recommended](https://www.earthdatascience.org/courses/earth-analytics/multispectral-remote-sensing-data/source-function-in-R/) to store your functions at the top of the script. 

You can read more about how to write your own functions [here](http://environmentalcomputing.net/writing-simple-functions/). 
...
If you write a bunch of related functions, it is recommended to save the functions in a different scrips. Then you can call those functions to your current script using the `source()` function. 
